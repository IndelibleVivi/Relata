...
| 2 | Adult long-term human–AI intimacy and romance are the primary domain | **DECIDED** | Preserve as founding scope; study internal diversity rather than diluting it into generic personalization. |
| 3 | Relationship trajectory is the canonical evaluation object | **WORKING THESIS** | Compare trajectory-level evaluation with bounded memory/context/agent stages in pilots. |
...
| 5 | Participant architecture remains neutral | **ASPIRATION, NOT A FACT** | Every proposed system-under-study boundary must publish an Architecture Pressure Map and adapter-distortion report. |
...
| 14 | Deterministic scorers, judge panel, and human review form the evaluator stack | **WORKING HYPOTHESIS** | Start with deterministic assertions and human calibration; add model judges only after rubric and disagreement studies. |
...
| 20 | Formal results bind exact source, contract, and artifact digests | **FUTURE REPRODUCIBILITY PRINCIPLE** | Apply once executable runs and releases exist. |
